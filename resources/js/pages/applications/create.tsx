  ...
  return (
    <AppLayout>
      ...
      <div className="container mx-auto mt-6 p-6 bg-white dark:bg-gray-800 rounded-lg shadow">
        <h2 className="text-2xl font-semibold mb-4 text-green-600 dark:text-green-400">Submit New Application</h2>
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            {errors.ward_id && <div className="text-red-600 dark:text-red-400 text-sm mt-1">{errors.ward_id}</div>}
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
            />
            {errors.date_of_birth && <div className="text-red-600 dark:text-red-400 text-sm mt-1">{errors.date_of_birth}</div>}
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
            />
            {errors.id_number && <div className="text-red-600 dark:text-red-400 text-sm mt-1">{errors.id_number}</div>}
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
            />
            {errors.phone && <div className="text-red-600 dark:text-red-400 text-sm mt-1">{errors.phone}</div>}
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              required
            ></textarea>
            {errors.address && <div className="text-red-600 dark:text-red-400 text-sm mt-1">{errors.address}</div>}
          </div>
          ...
          <div>
            ...
            {errors.education_level && <div className="text-red-600 dark:text-red-400 text-sm mt-1">{errors.education_level}</div>}
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
            />
            {errors.institution_name && <div className="text-red-600 dark:text-red-400 text-sm mt-1">{errors.institution_name}</div>}
          </div>
          ...
          <div>
            ...
            />
            {errors.graduation_year && <div className="text-red-600 dark:text-red-400 text-sm mt-1">{errors.graduation_year}</div>}
          </div>
          ...
          <div>
            ...
            <input
              ...
              required
            />
            {errors.business_type && <div className="text-red-600 dark:text-red-400 text-sm mt-1">{errors.business_type}</div>}
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              required
            ></textarea>
            {errors.business_description && <div className="text-red-600 dark:text-red-400 text-sm mt-1">{errors.business_description}</div>}
          </div>

          {/* Requested Amount */}
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Requested Amount (Ksh) *</label>
            <input
              type="number"
              ...
              required
            />
            {errors.requested_amount && <div className="text-red-600 dark:text-red-400 text-sm mt-1">{errors.requested_amount}</div>}
          </div>

          {/* Business Plan */}
          <div className="md:col-span-2">
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Business Plan *</label>
            <textarea
              name="business_plan"
              ...
              required
            ></textarea>
            {errors.business_plan && <div className="text-red-600 dark:text-red-400 text-sm mt-1">{errors.business_plan}</div>}
          </div>
